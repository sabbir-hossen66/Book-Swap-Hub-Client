          ...
          <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            <div className="w-full">
              ...
              <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                <div>
                  <label className="block mb-2 text-sm text-gray-700 dark:text-gray-200">First Name</label>
                ...
                <div>
                  <label className="block mb-2 text-sm text-gray-700 dark:text-gray-200">Last name</label>
                ...
                <div>
                  <label className="block mb-2 text-sm text-gray-700 dark:text-gray-200">Photo Url</label>
